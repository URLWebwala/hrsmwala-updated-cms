const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./html2pdf-Bqnx6T43.js","./ui-Dc_0HCyE.js","./app-CNv9kRBh.js","./app-CcWcSgLu.css"])))=>i.map(i=>d[i]);
import{_ as g}from"./app-CNv9kRBh.js";import{j as i}from"./ui-Dc_0HCyE.js";import{B as x}from"./button-B4iPsljO.js";import{a as f,b,c as h}from"./tooltip-Dtbq2PyC.js";import{f as v,a as r,k as p}from"./helpers-DbIfK-nW.js";import{u as _}from"./useTranslation-CXmbFMPU.js";import{D as y}from"./download-CvJA87xq.js";import"./index-DJ4AQ5mO.js";import"./index-B3-HY_Q0.js";import"./utils-Dsh5hxRS.js";import"./utils-BEilrgaf.js";import"./index-ltOa6rkt.js";import"./createLucideIcon-Dovszg4y.js";function F({contract:e,variant:s="outline",size:a="sm"}){const{t}=_(),d=()=>{var n;const l=document.createElement("div");l.innerHTML=`
        ...
        `;const m={margin:.5,filename:`contract-${e.contract_number}.pdf`,image:{type:"jpeg",quality:.98},html2canvas:{scale:2},jsPDF:{unit:"in",format:"letter",orientation:"portrait"}};g(()=>import("./html2pdf-Bqnx6T43.js").then(o=>o.h),__vite__mapDeps([0,1,2,3]),import.meta.url).then(o=>{o.default().set(m).from(l).save()})};return i.jsxs(f,{children:[i.jsx(b,{asChild:!0,children:i.jsx(x,{variant:s,size:a,onClick:d,children:i.jsx(y,{className:"h-4 w-4"})})}),i.jsx(h,{children:i.jsx("p",{children:t("Download PDF")})})]})}export{F as default};

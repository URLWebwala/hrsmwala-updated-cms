...
Route::prefix('api')->middleware(['api.json'])->group(function () {
    Route::group(['middleware' => ['auth:sanctum']], function () {
        // Backward-compatible endpoint used by tracker clients
        Route::post('create-task',[TaskApiController::class,'taskCreateAndUpdate']);

        Route::group(['prefix' => 'taskly'], function () {
        ...
        Route::get('my-work-items', [TaskApiController::class, 'myWorkItems']);
        Route::post('work-item-status-update', [TaskApiController::class, 'workItemStatusUpdate']);
        });
    });
});
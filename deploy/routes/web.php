...
Route::middleware(['auth', 'verified', 'PlanModuleCheck'])->group(function () {
    ...
    Route::post('settings/tracker-app', [SettingController::class, 'updateTrackerAppSettings'])->name('settings.tracker-app.update');
    ...
    // Header / settings web routes for notifications and sound settings
    Route::get('/notifications', [NotificationApiController::class, 'index'])->name('web.notifications.index');
    Route::post('/notifications/mark-read', [NotificationApiController::class, 'markRead'])->name('web.notifications.mark-read');
    Route::post('/notifications/mark-all-read', [NotificationApiController::class, 'markAllRead'])->name('web.notifications.mark-all-read');
    Route::post('/notifications/clear-read', [NotificationApiController::class, 'clearRead'])->name('web.notifications.clear-read');
    Route::get('/sound-settings', [SoundSettingApiController::class, 'index'])->name('web.sound-settings.index');
    Route::post('/sound-settings/upload', [SoundSettingApiController::class, 'upload'])->name('web.sound-settings.upload');
    Route::post('/sound-settings/update', [SoundSettingApiController::class, 'update'])->name('web.sound-settings.update');

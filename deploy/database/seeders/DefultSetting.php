...
class DefultSetting extends Seeder
{
    ...
    public function run()
    {
        ...
        $admin_settings = [
            ...
            'favicon' => 'favicon.png',
            'titleText' => !empty(env('APP_NAME')) ? env('APP_NAME') : 'Hrmswala SaaS',
            'footerText' => 'Copyright © ' . (!empty(env('APP_NAME')) ? env('APP_NAME') : 'Hrmswala SaaS'),
            ...
            'metaTitle' => !empty(env('APP_NAME')) ? env('APP_NAME') . ' - Dashboard' : 'Hrmswala SaaS - Dashboard',

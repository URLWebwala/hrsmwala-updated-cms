            ...
            >
                <header
                    ...
                    >
                        ...
                        {/* Download Tracker App Button */}
                        {(adminAllSetting?.tracker_app_file) && (
                            <Button
                                variant="default"
                                size="sm"
                                asChild
                                className="bg-[#3498db] text-white hover:bg-[#2980b9] h-9 px-4 rounded-md font-medium"
                            >
                                <a href={`/storage/${adminAllSetting.tracker_app_file}`} download>
                                    {t('Download tracker app')}
                                </a>
                            </Button>
                        )}
                        <HeaderNotifications />

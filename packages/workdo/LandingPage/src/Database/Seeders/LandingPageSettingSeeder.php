    ...
    private function getDefaultSections(): array
    {
        return [
            'hero' => [
                ...
                'subtitle' => 'Streamline your entire business lifecycle, from finance to operations, with Hrmswala SaaS. One platform, infinite possibilities.',
                'primary_button_text' => 'Start Free Trial',
                'primary_button_link' => route('register'),
                'secondary_button_text' => 'Login',
                'secondary_button_link' => route('login'),
                'highlight_text' => 'Hrmswala SaaS',
            ...
            'benefits' => [
                'variant' => 'benefits1',
                'title' => 'Why Choose Hrmswala SaaS?',
                'benefits' => [
            ...
            'cta' => [
                ...
                'subtitle' => 'Join thousands of businesses already using Hrmswala SaaS to streamline their operations.',

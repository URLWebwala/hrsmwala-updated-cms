                                        ...
                                        <div className="text-center space-y-4">
                                            ...
                                            <div className="space-y-3 py-4">
                                                ...
                                                <div className="flex items-center space-x-2">
                                                    <div className="w-2 h-2 rounded-full flex-shrink-0" style={{ backgroundColor: colors.primary }}></div>
                                                    <span className="text-sm font-medium text-gray-700">
                                                        {plan.storage_limit === -1 ? t('Unlimited storage') : `${Math.round(plan.storage_limit / (1024 * 1024))}${t("GB storage")}`}
                                                    </span>
                                                </div>
                                                {/* Tracker Features */}
                                                {plan.modules && plan.modules.includes('TimeTracker') ? (
                                                    <>
                                                        <div className="flex items-center space-x-2">
                                                            <div className="w-2 h-2 rounded-full flex-shrink-0" style={{ backgroundColor: colors.primary }}></div>
                                                            <span className="text-sm font-medium text-gray-700 font-semibold">{t('Desktop Tracker Access')}</span>
                                                        </div>
                                                        <div className="flex items-center space-x-2">
                                                            <div className="w-2 h-2 rounded-full flex-shrink-0" style={{ backgroundColor: colors.primary }}></div>
                                                            <span className="text-sm font-medium text-gray-700 font-semibold">{t('Screenshot Monitoring')}</span>
                                                        </div>
                                                        <div className="flex items-center space-x-2">
                                                            <div className="w-2 h-2 rounded-full flex-shrink-0" style={{ backgroundColor: colors.primary }}></div>
                                                            <span className="text-sm font-medium text-gray-700 font-semibold">{t('Activity Tracking')}</span>
                                                        </div>
                                                    </>
                                                ) : (
                                                    <div className="flex items-center space-x-2 text-gray-400 italic">
                                                        <div className="w-2 h-2 rounded-full flex-shrink-0 bg-gray-200"></div>
                                                        <span className="text-sm font-medium">{t('No Desktop Tracker')}</span>
                                                    </div>
                                                )}
                                                {plan.trial && (
                                                    <div className="flex items-center space-x-2">
